<template>
    <div class="d-flex align-center justify-center" style="height: 90vh">
        <v-sheet width="400" class="mx-auto">
            ...
            <div class="mt-2">
                <p class="text-body-2">Don't have an account? <RouterLink to="/register">Sign Up</RouterLink></p>
            </div>
        </v-sheet>
    </div>
</template>
    ...
    methods: {
        login() {
            let data = {    
                    ...
                    axios.post("http://localhost:8000/api/users/login", data,{ withCredentials: true })    
                        .then((response) => {
